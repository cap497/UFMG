...
class StoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPrice = channel.unary_unary(
                ...
                response_deserializer=store__pb2.Price.FromString,
        ...
        self.Shutdown = channel.unary_unary(
                ...
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=store__pb2.StoreShutdownResponse.FromString,
                _registered_method=True)
...
def add_StoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetPrice': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=store__pb2.Price.SerializeToString,
            ),
            ...
            'Shutdown': grpc.unary_unary_rpc_method_handler(
                    servicer.Shutdown,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=store__pb2.StoreShutdownResponse.SerializeToString,
            ),
    }
...
class Store(object):
    ...
    def Shutdown(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/store.Store/Shutdown',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            store__pb2.StoreShutdownResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
